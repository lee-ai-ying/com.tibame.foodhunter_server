...
/**
 * Servlet implementation class RestRelatedPost
 */
@WebServlet("/post/RestRelatedPost")
public class RestRelatedPost extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
	            ...
	            // 取得貼文列表（包含照片）
	            List<Post> posts = postService.getPostByRestId(restaurant);
